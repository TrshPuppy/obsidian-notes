...
```
## 2. Vulnerability Scanning w/ [Nikto](../../../cybersecurity/TTPs/recon/tools/vuln-scanning/nikto.md)
`kioptrix_nikto.txt`:
```bash
- Nikto v2.5.0
---------------------------------------------------------------------------
...
##### [Feroxbuster](../../../cybersecurity/TTPs/recon/tools/dir-and-subdomain/feroxbuster.md)
Feroxbuster is a tool similar to [gobuster](../../../cybersecurity/TTPs/recon/tools/dir-and-subdomain/gobuster.md) except it's able to *do recursive enumeration*. We can try feroxbuster against Kioptrix like this:
```bash
