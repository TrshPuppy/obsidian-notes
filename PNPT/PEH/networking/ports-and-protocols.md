...
There are 65,535 ports available to connect to a device on a network. [Ports](/networking/routing/ports.md) are controlled by software which is managed by the device's operating system.
